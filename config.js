...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://logos.textgiraffe.com/logos/logo-name/Zaid-designstyle-kiddo-m.png" ; // SET LOGO FOR IMAGE 
...
module.exports = {
  ...
  ownername:process.env.OWNER_NAME|| "It'x zaid ",
